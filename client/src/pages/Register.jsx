  ...
  return (
    <div className="mx-auto grid min-h-[85vh] max-w-5xl grid-cols-1 items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2">
      <div className="hidden animate-fade-up overflow-hidden rounded-2xl shadow-lift lg:block">
        <img src={regImage} alt="" className="h-full max-h-[620px] w-full object-cover" />
      </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <label
                    key={option.value}
                    className={`cursor-pointer rounded-tag border px-3.5 py-2.5 text-sm transition-all ${
                      form.role === option.value
                        ? "border-brass-500 bg-brass-50 text-ink-800 shadow-glow"
